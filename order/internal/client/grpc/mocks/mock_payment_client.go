...
func (_m *PaymentClient) PayOrder(ctx context.Context, orderId string, userId string, paymentMethod model.PaymentMethod) (string, error) {
...
func (_e *PaymentClient_Expecter) PayOrder(ctx interface{}, orderId interface{}, userId interface{}, paymentMethod interface{}) *PaymentClient_PayOrder_Call {
	return &PaymentClient_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, orderId, userId, paymentMethod)}
}

func (_c *PaymentClient_PayOrder_Call) Run(run func(ctx context.Context, orderId string, userId string, paymentMethod model.PaymentMethod)) *PaymentClient_PayOrder_Call {
