...
func encodeOrderCancelByIdResponse(response OrderCancelByIdRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *OrderCancelByIdNoContent:
		w.WriteHeader(204)
...
func encodePayOrderByIdResponse(response PayOrderByIdRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
