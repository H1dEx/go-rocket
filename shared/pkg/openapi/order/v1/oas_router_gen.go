				...
				case '/': // Prefix: "/"
					...
					case 'c': // Prefix: "cancel"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handleOrderCancelByIdRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "POST")
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handlePayOrderByIdRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "POST")
				...
				case '/': // Prefix: "/"
					...
					case 'c': // Prefix: "cancel"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = OrderCancelByIdOperation
								r.summary = "Отменяет заказ"
								r.operationID = "OrderCancelById"
					...
					case 'p': // Prefix: "pay"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = PayOrderByIdOperation
								r.summary = "Создаёт новый заказ на основе выбранных пользователем деталей"
								r.operationID = "PayOrderById"
