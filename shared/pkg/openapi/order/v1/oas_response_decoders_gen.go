...
func decodeOrderCancelByIdResponse(resp *http.Response) (res OrderCancelByIdRes, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &OrderCancelByIdNoContent{}, nil
	case 404:
		// Code 404.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
...
func decodePayOrderByIdResponse(resp *http.Response) (res PayOrderByIdRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
