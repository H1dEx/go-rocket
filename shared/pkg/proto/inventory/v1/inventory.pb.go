...
// Category категории детали Part
type Category int32
...
// GetPartRequest запрос информации о детали
...
// ListPartsRequest ответ со списком деталей
type ListPartsResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Part Список найденных деталей
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBGZEgithub.com/H1dEx/go-rocket/shared/pkg/proto/inventory/v1;inventory_v1b\x06proto3"
