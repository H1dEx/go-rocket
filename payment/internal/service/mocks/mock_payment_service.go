...
// PayOrder provides a mock function with given fields: ctx, orderId, userId, paymentMethod
func (_m *PaymentService) PayOrder(ctx context.Context, orderId string, userId string, paymentMethod string) (string, error) {
...
func (_e *PaymentService_Expecter) PayOrder(ctx interface{}, orderId interface{}, userId interface{}, paymentMethod interface{}) *PaymentService_PayOrder_Call {
	return &PaymentService_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, orderId, userId, paymentMethod)}
}

func (_c *PaymentService_PayOrder_Call) Run(run func(ctx context.Context, orderId string, userId string, paymentMethod string)) *PaymentService_PayOrder_Call {
...
func (_c *PaymentService_PayOrder_Call) Return(transactionId string, err error) *PaymentService_PayOrder_Call {
